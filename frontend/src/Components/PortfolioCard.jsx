...
const PortfolioCard = () => {
  return (
    ...
    >
      <h3 className="text-4xl lg:text-6xl font-bold py-3 border-2 border-transparent border-b-red-1000 ">
        Portfolio*
      </h3>
      <h3 className="text-xl lg:text-2xl py-3 border-2 border-transparent border-b-red-400">
        Vignesh Maram
      </h3>
      <h3 className="text-xl lg:text-2xl py-3">MERN Stack Developer</h3>
      <h3 className="text-xl lg:text-2xl py-3">Competetive Programmer</h3>
    </div>
  );
};
